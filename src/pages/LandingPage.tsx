...
import { Shield, Zap, Activity, Users, BarChart3, Map, Camera, FileCheck2, ArrowRight, Sparkles } from 'lucide-react';
...
export function LandingPage() {
  ...
  return (
    <div className="space-y-16 pb-20 pt-8">
      ...
      <section className="relative text-center px-4 min-h-[60vh] flex flex-col items-center justify-center">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: "easeOut" }} className="w-full max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-300 text-sm font-semibold mb-8 shadow-[0_0_15px_rgba(99,102,241,0.2)]">
            <Sparkles className="w-4 h-4 text-indigo-400" /> AI-assisted civic issue reporting
          </div>
          
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tight mb-6 leading-[1.08]">
            Make your city work better.<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-violet-500 to-emerald-500 animate-gradient bg-[length:200%_auto]">
              Report. Track. Resolve.
            </span>
          </h1>
          
          <p className="text-lg md:text-xl text-slate-400 max-w-3xl mx-auto mb-10 leading-relaxed font-medium">
            Raise local issues with AI-assisted details, verify reports with your neighborhood, and follow every update until the work is done.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              <Map className="w-5 h-5" /> Open Live Map
            </button>
          </div>
        </motion.div>
      </section>
      ...
      {/* How CommunityHero Works */}
      <section className="px-6 py-12 max-w-6xl mx-auto text-center">
        <h2 className="text-3xl font-bold text-white mb-16">How CommunityHero Works</h2>
        ...
        >
          ...
          {[
            { icon: Camera, title: "Report", desc: "Share the issue with a photo and location", color: "from-blue-500 to-cyan-500" },
            { icon: Zap, title: "AI Triage", desc: "Severity and department are suggested instantly", color: "from-purple-500 to-pink-500" },
            { icon: FileCheck2, title: "Verify", desc: "Neighbors confirm what needs attention", color: "from-amber-500 to-orange-500" },
            { icon: Shield, title: "Resolve", desc: "Authorities update progress until it is fixed", color: "from-emerald-500 to-teal-500" }
          ].map((step, i) => (
      ...
      <section className="px-6 py-12 max-w-4xl mx-auto text-center">
        <div className="p-12 rounded-[3rem] bg-gradient-to-br from-indigo-900/40 to-purple-900/40 border border-indigo-500/20 relative overflow-hidden">
          <div className="relative z-10">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready to improve your neighborhood?</h2>
            <p className="text-xl text-indigo-200 mb-10 max-w-2xl mx-auto">
              Report issues, verify updates, earn civic points, and help local teams respond faster.
            </p>
            <button 
